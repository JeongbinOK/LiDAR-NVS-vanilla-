...
#
# Local copy — points to vanilla/third_party/diff-gaussian-rasterization-2d/
#
import os
...
parent_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "diff-gaussian-rasterization-2d")
_C = load(
