...
Utonia XYZI input and this builder returns occupied Utonia tokens directly. No
separate intensity encoder is constructed. In the legacy path, intensity per
