...
from models.module.point2gaus import Point2GaussianModel
from utils.eval_utils import evaluate_pair_sample, write_ply
...
class ModelWrapper(LightningModule):
    def __init__(
        ...
        # Set up the model.
        self.p2g_model = Point2GaussianModel(self.p2g_cfg)
        self.g2g_model = None
        self.g2p_model = None
    ...
    def training_step(self, batch, batch_idx):
        ...
        self._log_losses(out, prefix="train")
